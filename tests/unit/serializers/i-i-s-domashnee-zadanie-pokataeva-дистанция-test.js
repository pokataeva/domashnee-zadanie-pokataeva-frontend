...
moduleForModel('i-i-s-domashnee-zadanie-pokataeva-дистанция', 'Unit | Serializer | i-i-s-domashnee-zadanie-pokataeva-дистанция', {
  // Specify the other units that are required for this test.
  needs: [
    'serializer:i-i-s-domashnee-zadanie-pokataeva-дистанция',
    'service:syncer',
    'transform:file',
    'transform:decimal',
    'transform:guid',
